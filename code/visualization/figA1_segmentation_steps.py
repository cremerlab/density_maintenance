...
image = skimage.io.imread(
    '../../data/example_images/wildtype_glucose_example.tif')
...
plt.xticks([])
plt.yticks([])
plt.savefig('../../figures/appendix/seg_dem_01_phase.pdf',
            bbox_inches='tight')
...
plt.xticks([])
plt.yticks([])
plt.savefig('../../figures/appendix/seg_dem_02_tophat.pdf')
...
plt.xticks([])
plt.yticks([])
plt.savefig('../../figures/appendix/seg_dem_03_otsu.pdf')
...
plt.xticks([])
plt.yticks([])
plt.savefig('../../figures/appendix/seg_dem_04_LoG.pdf')
...
plt.xticks([])
plt.yticks([])
plt.savefig('../../figures/appendix/seg_dem_05_isolated.pdf')
...
plt.xticks([])
plt.yticks([])
plt.savefig('../../figures/appendix/seg_dem_06_rotated.pdf')
...
plt.xticks([])
plt.yticks([])
plt.savefig('../../figures/appendix/seg_dem_07_morph.pdf')
...
plt.xticks([])
plt.yticks([])
plt.savefig('../../figures/appendix/seg_dem_08_cont.pdf')
...
plt.xticks([])
plt.yticks([])
plt.savefig('../../figures/appendix/seg_dem_09_contfilt.pdf')
...
plt.xticks([])
plt.yticks([])
plt.savefig('../../figures/appendix/seg_dem_10_spline.pdf')
# %%
# Compute curvature
...
plt.xticks([])
plt.yticks([])
plt.savefig('../../figures/appendix/seg_dem_11_curvature.pdf')
...
plt.xticks([])
plt.yticks([])
plt.savefig('../../figures/appendix/seg_dem_12_anatomy.pdf')
...
plt.xticks([])
plt.yticks([])
plt.savefig('../../figures/appendix/seg_dem_13_meas.pdf')
...
plt.xticks([])
plt.yticks([])
plt.savefig('../../figures/appendix/seg_dem_14_length.pdf')