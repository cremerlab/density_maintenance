...
fig, ax = plt.subplots(1, 4, figsize=(6.5, 1.5))
...
ax[0].plot(lam_range, np.exp(log_prot_popt[1] + log_prot_popt[0]*lam_range), 'k-', lw=1, label='fit')
ax[1].plot(lam_range, np.exp(log_rna_popt[1] + log_rna_popt[0]*lam_range), 'k-', lw=1, label='fit')              
ax[2].plot(lam_range, np.exp(log_vol_popt[1] + log_vol_popt[0]*lam_range), 'k-', lw=1, label='fit')
ax[3].plot(lam_range, np.exp(log_sa_popt[1] + log_sa_popt[0]*lam_range), 'k-', lw=1, label='fit')
