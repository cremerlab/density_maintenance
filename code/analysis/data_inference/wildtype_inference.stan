...
//     vector<lower=0>[J_mem] mem_per_biomass_mu = mem_per_biomass_mu .* sd(mem_per_biomass) + mean(mem_per_biomass);
//     vector<lower=0>[J_peri] peri_per_biomass_mu = peri_per_biomass_mu .* sd(peri_per_biomass) + mean(peri_per_biomass);
//     vector<lower=0>[J_prot] prot_per_biomass_mu = prot_per_biomass_mu .* sd(prot_per_biomass) + mean(prot_per_biomass);
//     vector<lower=0>[J_rna] rna_per_biomass_mu = rna_per_biomass_mu .* sd(rna_per_biomass) + mean(rna_per_biomass);
...
generated quantities {
    ...
    vector<lower=0>[J_size] surface_to_volume_mu = surface_area_mu ./ volume_mu;
